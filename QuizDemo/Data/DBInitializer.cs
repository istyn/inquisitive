...
namespace QuizDemo.Data
{
    public static class DBInitializer
    {
        public static void Initialize(ExamContext context)
        {
            context.Database.CreateIfNotExists();//.EnsureCreated();       //create the empty database
            if (context.Questions.Any())            //if it already exists
            {
                return;                             //then don't add the data
            }
            ...
            var questions = new Question[]
            {
                ...
                new Question { QuestionId = 5, Text = "Before the Mount Everest was discovered, what was the tallest mountain in the world?", Hint="Although not always the tallest mountain, discovering that it was didn't change the facts.", CorrectId = 19 },
            ...
            var answers = new Answer[]
            {
                ...
                new Answer { QuestionId =2, Text = "Yes, the law doesn't say you can't" },
                ...
                new Answer { QuestionId =7, Text = "Two of every species" },
                ...
                new Answer { QuestionId =19, Text = "Toothpicks for your eyelids" },
